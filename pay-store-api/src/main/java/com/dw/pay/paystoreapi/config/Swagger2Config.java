package com.dw.pay.paystoreapi.config;
...
public class Swagger2Config extends WebMvcConfigurerAdapter {
    ...
    public Docket createRestApi(){
        ...
        apiSelectorBuilder.apis(RequestHandlerSelectors.basePackage("com.dw.pay.paystoreapi.web.api"));
